...
// menetapkan variable menu aktif dan tidak aktif, yang digunakan agar sidebar menu menjadi aktif
$_menuAktif = 'forum';
$_submenuAktif = 'tambah_topik';
...
<section class="" style="background-color: #FAF7F5">
    ...
    <div class="container p-3 mx-auto ">
        <div class="flex items-center lg:hidden md:hidden sm:hidden mb-6">
            ...
            <h1 class="flex-grow text-header font-bold text-xl justify-end ms-3">Tambah Topik</h1>
        </div>
